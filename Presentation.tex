...
\title[YOLO]{Object Detection with YOLO} % The short title appears at the bottom of every slide, the full title is only on the title page

\author{Behnia - Heydari} % Your name
...
%------------------------------------------------
\section{Computer Vision} % Sections can be created in order to organize your presentation into discrete blocks, all sections and subsections are automatically printed in the table of contents as an overview of the talk
%------------------------------------------------
...
\begin{frame}
\frametitle{Closer Look(CONT.)}
 {\color{red} IT WON'T FIT ?!!!!!!!
 \\
Can't apply 3*3 filter }
\begin{figure}
...
\begin{figure}
	\includegraphics[width=.5\linewidth]{Pics/padding.png}
	\caption{Padding}
\end{figure}
